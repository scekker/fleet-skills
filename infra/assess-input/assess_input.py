...
RECOMMENDATIONS = {
    ...
    "DANGER": (
        "🔴 DANGER — DO NOT LOAD\n"
        "   Loading this file would likely crash the session via context spiral.\n"
        "   Action: extract plain text first, then chunk into ≤40KB pieces.\n"
        "   Consider: grep for keywords, extract TOC/headings only, or\n"
        "   process section-by-section in isolated subagents."
    ),
}
...
def main():
    ...
    assess(args.file, as_json=args.json)
